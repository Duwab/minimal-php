        ...
        <td>
            <p class="name">
                {% if (file.url) { %}
					...
					<a href="{%=file.url%}" title="{%=file.name%}" target="_blank">Stream</a>
                {% } else { %}
                    <span>{%=file.name%}</span>
                {% } %}
            </p>
...
<script src="/assets/js/upload/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="/assets/js/upload/jquery.fileupload-video.js"></script>
